...
export const IncentiveToursSection: React.FC<IncentiveToursSectionProps> = ({ onOpenWhatsApp }) => {
  return (
    <section id="incentive-tours" className="py-16 sm:py-20 bg-white text-[#111827] relative border-b border-[#E5E7EB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-3">
          ...
          <h2 className="font-heading text-2xl sm:text-4xl font-extrabold text-[#071B3D]">
        ...
        {/* Destination Showcase Grid: 1 col on mobile, 2 col on tablet, 3 col on desktop */}
              ...
              >
                ...
                <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between space-y-2">
                  <div className="space-y-1">
                    <h3 className="font-heading text-lg sm:text-xl font-bold text-[#071B3D] group-hover:text-[#0A2D68] transition-colors">
                      {dest.name}
                    </h3>
